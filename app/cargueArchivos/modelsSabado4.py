...
class DataArchivoCargue(models.Model):
    ...
    archivocarguefechacreacion = models.DateTimeField()
    archivocarguearchivotipocargue = models.ForeignKey('DataTipoCargue', models.DO_NOTHING,default='')
    archivocarguecantidadcolumnasobligatorias = models.IntegerField(db_column='archivocarguecantidadcolumnasObligatorias')  # Field name made lowercase.
    archivocargueestado = models.BooleanField()
...
class DataArchivoCargueProcesar(models.Model):
    archivocargueprocesarfechacreacion = models.DateTimeField()
    archivocargueprocesararchivo = models.CharField(max_length=100)
    archivocargueprocesarestado = models.BooleanField()
    archivocargueprocesararchivotipocargue = models.ForeignKey('DataTipoCargue', models.DO_NOTHING,default='')
...
class DataArchivoColumnas(models.Model):
    archivocolumnasarchivoplano = models.CharField(max_length=100, blank=True, null=True)
    archivocolumnasestado = models.BooleanField()
    archivocolumnascolumnas = models.CharField(max_length=20000)
    archivocolumnasarchivo = models.ForeignKey(DataArchivoCargue, models.DO_NOTHING,default='')
...
class DataTipoCargue(models.Model):
    ...
    tipocarguefechacreacion = models.DateTimeField()
