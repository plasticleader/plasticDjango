...
class DataArchivosprocesados(models.Model):
    archivos_sin_proceso = models.CharField(max_length=512, blank=True, null=True)
...
class DataClientes(models.Model):
    cliente_empresa = models.ForeignKey(DataEmpresa, models.DO_NOTHING, db_column='cliente_empresa', blank=False, null=False)
...
class DataInteraccionpersona(models.Model):
    ...
    interaccionpersona_persona = models.ForeignKey('DataPersona', models.DO_NOTHING, db_column='interaccionpersona_persona', blank=True, null=True)
...
class DataInteraccionpersonallamada(models.Model):
    ...
    interaccionpersonallamada_token = models.ForeignKey('DataPersona', models.DO_NOTHING, db_column='interaccionpersonallamada_token', blank=True, null=True)
...
class DataObligacion(models.Model):
    ...
    obligacion_persona = models.ForeignKey('DataPersona', models.DO_NOTHING, db_column='obligacion_persona', blank=True, null=True)
...
class DataTipoobligacionoferta(models.Model):
    ...
    tipodoobligacionoferta_usuario = models.ForeignKey('DataPersona', models.DO_NOTHING, db_column='tipodoobligacionoferta_usuario', blank=True, null=True)
    estado = models.CharField(max_length=1, blank=True, null=True)
...
class DataTipotelefono(models.Model):
    tipotelefono_id = models.CharField(primary_key=True, max_length=20)
